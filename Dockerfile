...
#
RUN curl -LO http://vault.centos.org/7.0.1406/os/x86_64/Packages/wget-1.14-10.el7.x86_64.rpm && \
...
#
RUN curl -LO https://ftp.drupal.org/files/projects/drupal-7.42.tar.gz && \
...
#
RUN curl -LO http://archive.apache.org/dist/tomcat/tomcat-7/v7.0.69/bin/apache-tomcat-7.0.69.tar.gz && \
...
#
#
RUN curl -LO http://mirror.switch.ch/ftp/pool/4/mirror/scientificlinux/7.0/x86_64/updates/security/java-1.8.0-openjdk-1.8.0.91-0.b14.el7_2.x86_64.rpm && \
    curl -LO http://mirror.switch.ch/ftp/pool/4/mirror/scientificlinux/7.0/x86_64/updates/security/java-1.8.0-openjdk-headless-1.8.0.91-0.b14.el7_2.x86_64.rpm && \
    touch /var/lib/rpm/* && \
...
#
RUN curl -LO http://vault.centos.org/7.0.1406/os/x86_64/Packages/tomcat-7.0.42-4.el7.noarch.rpm && \
    curl -LO http://vault.centos.org/7.0.1406/os/x86_64/Packages/tomcat-el-2.2-api-7.0.42-4.el7.noarch.rpm && \
    curl -LO http://vault.centos.org/7.0.1406/os/x86_64/Packages/tomcat-jsp-2.2-api-7.0.42-4.el7.noarch.rpm && \
    curl -LO http://vault.centos.org/7.0.1406/os/x86_64/Packages/tomcat-lib-7.0.42-4.el7.noarch.rpm && \
    curl -LO http://vault.centos.org/7.0.1406/os/x86_64/Packages/tomcat-servlet-3.0-api-7.0.42-4.el7.noarch.rpm && \
    touch /var/lib/rpm/* && \
...
#
RUN curl -LO https://pypi.python.org/packages/8c/2b/e6e2f554368785c7eb68d618fd6457625be1535e807f6abf11c7db710f34/hpack-2.1.1.tar.gz && \
...
#
RUN curl -LO http://repo1.maven.org/maven2/commons-beanutils/commons-beanutils/1.8.0/commons-beanutils-1.8.0-sources.jar

# activesupport 4.2.1 - GEM package (Ruby)
#
# CVE-2015-3227, CVE-2015-3226	
#
RUN curl -LO http://rubygems.org/downloads/activesupport-4.2.1.gem
...
#
RUN curl -LO https://nodejs.org/dist/v0.10.41/node-v0.10.41-linux-x64.tar.gz && \
...
#
RUN curl -LO https://ftp.heanet.ie/mirrors/gnu/bash/bash-4.3.tar.gz && \
